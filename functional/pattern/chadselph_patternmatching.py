"""
chadselph/patternmatching.py (Gitub Gist)
...
class OfType:
    ...
    # NOTE: Added by AJJ so that `OfType(...)` can be used as a dictionary key
    def __hash__(self):
        return hash(self.type)

    # TODO: Add common base class to implement `method chaining` of these classes

    # TODO: Add `class And:` so that conditionns can be combined
